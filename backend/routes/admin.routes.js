...
// Debug - check if middleware are defined
console.log('protect middleware:', typeof protect);
console.log('adminOnly middleware:', typeof adminOnly);

// Check if middleware exists before using them
if (typeof protect !== 'function' || typeof adminOnly !== 'function') {
    console.error('ERROR: Middleware functions are not properly imported!');
    process.exit(1);
}
